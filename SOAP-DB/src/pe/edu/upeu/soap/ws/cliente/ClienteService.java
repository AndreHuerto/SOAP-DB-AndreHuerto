...
public class ClienteService {
	public static void main(String[] args) {
		...
		System.out.println("Fecha " + pd.readVenta("2021-05-07", "2021-12-12", 1).getFecha());
		System.out.println("Nombre Completo " + pd.readVenta("2021-05-07", "2021-12-12", 1).getNombres() + " " + pd.readVenta("2021-05-07", "2021-05-10", 1).getApellidos());
